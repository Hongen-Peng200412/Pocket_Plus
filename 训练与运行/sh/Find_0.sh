...
# 本文件只描述 Find_0 的正式训练。它不申请 GPU、不创建 release、不实现锁，也不运行 smoke test。通常由 ../submit_task.sh 申请两张 H200 后执行。
...
cpc1_experiment_group="AdaLigand_Stage1/Find_0/CPC1"
cpc1_tag="Find_0/CPC1"                                                                # 额外兼任：wandb 项目名下的运行名称
cpc2_experiment_group="AdaLigand_Stage1/Find_0/CPC2"
cpc2_tag="Find_0/CPC2"                                                                # 额外兼任：wandb 项目名下的运行名称
...
# CPC1的运行产物落盘地址: /home/penghongen/Feedback/Pocket_Plus/logs/AdaLigand_Stage1-Find_0-CPC1/Find_0-CPC1____20260726T164033_CPC1
cpc1_run="${EXPERIMENT_FEEDBACK_ROOT}/logs/${cpc1_experiment_group//\//-}/${cpc1_tag//\//-}____${cpc1_stamp}"
# CPC2的运行产物落盘地址: /home/penghongen/Feedback/Pocket_Plus/logs/AdaLigand_Stage1-Find_0-CPC2/Find_0-CPC2____20260726T164033_CPC2
...
#                                  -----------------------------------------------------------------------------------------------                                 #
# --- 卡的申请/参数覆盖 ---
devices="${TASK_GPUS:-2}"  # allocation_runner.sh 把每节点 GPU 数写入 TASK_GPUS；直接运行时回退为两张卡。   # NOTE: 这里需要和 submit_task.sh 命令申请的卡数一致
