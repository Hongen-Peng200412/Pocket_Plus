...
# 在 Pocket_Plus 服务器项目根目录提交全部 16 个 train 分片：
#
# bash /home/penghongen/My_Project/Pocket_Plus/训练与运行/submit_task.sh \
#   --sh /home/penghongen/My_Project/Pocket_Plus/训练与运行/sh/infer/Find_0_train_F1.sh \
#   --resource <gpu_resource> \
#   --gpus 1 \
#   --cpus 8 \
#   --array '0-15' \
#   --after_hold \
#   --job-name find0_train_f1
#
# 数组编号就是全局分片编号；所有 0 至 15 的编号合起来才覆盖完整 train 清单。
